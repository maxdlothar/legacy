...
include('includes/functions_idb.php');
$page_title='ODIS Designer';
$start=((strpos($_REQUEST{'start'},':'))===FALSE)?(date('Y-m-d',$_REQUEST['start'])):($_REQUEST{'start'});
$end=((strpos($_REQUEST['end'],':'))===FALSE)?(date('Y-m-d',$_REQUEST['end'])):($_REQUEST['end']);
